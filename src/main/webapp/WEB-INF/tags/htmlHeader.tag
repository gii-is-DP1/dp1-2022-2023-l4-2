...
<%--
IdusMartii :: a Spring Framework demonstration
--%>
...
<head>
    ...
    <title>IdusMartii :: a Spring Framework demonstration</title>

    <%-- CSS generated from LESS --%>
    <spring:url value="/resources/css/idusmartii.css" var="idusmartiiCss"/>
    <link href="${idusmartiiCss}" rel="stylesheet"/>
