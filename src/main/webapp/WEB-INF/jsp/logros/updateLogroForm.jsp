...
<petclinic:layout pageName="logros">
    <jsp:body>
        <div style="text-align: center; ">
            <h2 style = "font-family: 'Dalek Pinpoint', sans-serif; font-size: 40px; margin-bottom: 3%;";>Actualizar Logro</h2>
        </div>
        <form:form modelAttribute="logro"
            ...
            <div style="text-align:center; margin-top: 1%;">
                    <button class="btn btn-default" style="font-size: 20px; font-family: sans-serif; "  type="submit" href="/logros/new">Actualizarlo</button>
            </div>
        </form:form>        
    </jsp:body>
</petclinic:layout>