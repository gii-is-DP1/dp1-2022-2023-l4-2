        ...
        <table  style= "width: 100%; text-align:center;position: relative;">
            ...
            <tr>
                <th style="text-align: center;">
                    ...
                    <img src="${errorImage}"/>
                    <h2 style="font-family: 'Dalek Pinpoint', sans-serif;width: 50%; text-align:center;position: relative;color: black;background-color: rgb(236, 182, 96);border-color: rgb(121, 102, 6); border-width: 2mm; ;">Ha ocurrido un error porque el servidor ha denegado tu solicitud</h2>
                </th>
            </tr>
