                ...
                <div style="padding: 1%; margin-bottom: -4%;">
                    <div style="text-align: center; margin: 1%;">
                                ...
                                <form:form modelAttribute="voto" class="form-horizontal">
                                    ...
                                    <div class="form-group has-feedback">                
                                        <tr>
                                            ...
                                            <td>
                                                <select name = "elegido">
                                                    <option value="false">Mantener el voto</option>
                                                    <option value="true">Forzar a que cambie el voto</option>
                                                </select>
                                            </td>
                                        </tr>
                                    </div>
                        ...
                        <c:if test ="${voto.faccion.getName() == 'Mercader'}">
                            El voto de ${voto.jugador.user.username} es para los Mercaderes,</br>
                            Ha realizado un voto neutro
                            <div style="text-align: center; margin: 1%;">
                                <spring:url value="/resources/images/votoNeutro.png" var="neutro" />
                                <img style ="width: 23%;  height: 45%;" src="${neutro}" />
                            </div>
                            <div>
                                <form:form modelAttribute="voto" class="form-horizontal">
                                    <input type="hidden" name="id" value="${voto.id}"/>
                                    <div class="form-group has-feedback">                
                                        <tr>
                                            <td>El Edil est&#225; obligado a cambiar su voto</td>
                                        </tr>
                                    </div>
                                    <div class="form-group">
                                        <div style="margin-bottom: 5%;">
                                            <button class="btn btn-default" type="submit">Mostrar a los dem&#225;s y obligarle a cambiar el voto</button>
                                        </div>
                                    </div>
                                </form:form>
                            </div>
